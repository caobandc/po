...
%>
                ...
                <div class="tpl-block">
                    ...
                    <div class="am-g">
                        <div class="tpl-form-body tpl-form-line">
                            <form class="am-form tpl-form-line-form" method="post" action="../servlet/editUser">
                                <%--<div class="am-form-group">--%>
                                    <%--<label for="user-name" class="am-u-sm-3 am-form-label">邮箱 <span class="tpl-form-line-small-title">E-mail</span></label>--%>
                                    <%--<div class="am-u-sm-9">--%>
                                        <%--<input type="email" class="tpl-form-input" id="user-name" placeholder="请输入邮箱地址">--%>
  ...
  <%--<option value="o">Orange</option>--%>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <textarea class="" rows="10" id="user-intro" placeholder="请输入一句话描述" name="content"></textarea>
                                    </div>
                                </div>
