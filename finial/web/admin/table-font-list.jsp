                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-type">是否为后台人员</th>
                                    ...
                                    <%
                                        ...
                                        List<Users> users = getuser.getListInfo(current);
//                                        delUser delete = new delUser();
                                    ...
                                    <tr>
                                        ...
                                        <td><%=nowId%></td>
                                        <td><a href="editUser.jsp?uid=<%=nowId%>"><%=u.getUsername()%></a></td>
                                        <%--<td><%=u.getDepartmentId()%></td>--%>
                                        <td class="am-hide-sm-only"><%=u.getIsBackuser()%></td>
                                        <td class="am-hide-sm-only"><%=u.getEmail()%></td>
                                            <td class="am-hide-sm-only"><%=u.getContent()%></td>
                                        <td>
                                            <div class="am-btn-toolbar">
                                                <div class="am-btn-group am-btn-group-xs">
                                                    <button class="am-btn am-btn-default am-btn-xs am-text-secondary" ><span class="am-icon-pencil-square-o"></span><a
                                                            href="editUser.jsp?uid=<%=nowId%>">编辑</a></button>
                                                    ...
                                                    <%--<form name="delete" method="get" action="servlet/delUser">--%>
                                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" ><span class="am-icon-trash-o"></span><a
                                                                href="../servlet/delUser?uid=<%=nowId%>">删除</a></button>
                                                    <%--</form>--%>
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <div class="am-cf">
                                    ...
                                    <div class="am-fr">
                                        <ul class="am-pagination tpl-pagination">
                                            <%
                                                List<Users> totalpage = getuser.getTotalInfo();
...
//                                                    System.out.println(j);
                                                    ...
                                                    if (current == com) {
                                                        ...
                                                        out.print("<a href=\"../admin/table-font-list.jsp?page=" + j + "\">");
                                                        out.print(j + "</a></li>");
                                                    } else {
                                                        out.print("<li>");
                                                        out.print("<a href=\"../admin/table-font-list.jsp?page=" + j + "\">");
