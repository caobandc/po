...
<%--<jsp:setProperty name='backUser' property='password'/>--%>
<%--<jsp:setProperty name='backUser' property='sex'/>--%>
<%--<jsp:setProperty name='backUser' property='username'/>--%>
<%--<jsp:setProperty name='backUser' property='isBackuser'/>--%>
            ...
            <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list tpl-header-list">
                ...
                <li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
                    ...
                    <ul class="am-dropdown-content">
                        <li><a href="form-amazeui.jsp"><span class="am-icon-bell-o"></span> 资料</a></li>
                        <%--<li><a href="#"><span class="am-icon-cog"></span> 设置</a></li>--%>
                        <li><a href="servlet/adminLogout"><span class="am-icon-power-off"></span> 退出</a></li>
                    </ul>
                </li>
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" method="post" action="#">
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <middle><jsp:getProperty name="backUser" property="username"/></middle>
                                        <input type="text" id="username" placeholder="输入你的电子邮件">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <middle><jsp:getProperty name="backUser" property="email"/></middle>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <middle><jsp:getProperty name="backUser" property="number"/></middle>
